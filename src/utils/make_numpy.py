...
if __name__ == '__main__':
    unzip(ZIPPED_INPUT_FILE, UNZIPPED_INPUT_FILE)

    X, y = preprocessing_pipeline(UNZIPPED_INPUT_FILE, save=True, apply_random_permutation=False)
    Xpermuted, _ = preprocessing_pipeline(UNZIPPED_INPUT_FILE, save=True, apply_random_permutation=True)
